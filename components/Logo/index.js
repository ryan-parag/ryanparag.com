  ...
  return(
    <LogoIcon>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 256 256">
        ...
        <path fill="#F7FE8B" fill-rule="evenodd" d="M180.154 123.904c-8.383 18.626-31.168 32.394-58.6 34.097a24.066 24.066 0 01-.361-4.154c0-17.709 19.433-32.065 43.404-32.065 5.482 0 10.727.751 15.557 2.122z" clip-rule="evenodd"/>
      </svg>
    </LogoIcon>
  )
}
